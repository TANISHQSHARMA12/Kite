    ...
    <>
      <div className="container p-5"> 
        <div className="row p-5 mb-5 mt-5 text-center">
          <h3 className="text-center" style={{ color: "#424242" }}>
            We pioneered the discount broking model in India.
            <br /> Now, we are breaking ground with our technology.
          </h3>
        </div>
        <div 
          className="row p-5 mt-5 border-top fs-5" 
          style={{ 
            lineHeight: "1.8", 
            fontSize: "1.05rem", 
            color: "black" 
        ...
        >
          ...
          <div className="col-6 p-5">
            ...
            <p className="mb-4">
              {/* Removed standard link styling to match plain text in screenshot 2 */}
              <span style={{ color: "inherit", textDecoration: "none" }}>Rainmatter</span>, 
